...
public:
	...
	static glm::vec3 getRandomPointOnSphere(glm::mat4 matrix);
	static glm::vec3 getRandomPointOnCube(glm::mat4 matrix);
	static glm::vec3 getCosineWeightedDirection(const glm::vec3& normal);
protected:
    geometryType type_;
